@extends('layouts.app')
@section('title', ($address->id ? '修改' : '新建') . '收货地址')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <user-addresses-create-and-edit inline-template>
                    @if($address->id)
                    <form action="{{ route('user_addresses.update', ['user_address' => $address->id ]) }}" method="post" role="form" class="form-horizontal">
                        {{ method_field('PUT') }}
                    @else
