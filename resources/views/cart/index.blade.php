                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 col-md-7">
                                <select name="address" class="form-control">
                                    ...
                                    <option value="{{ $address->id }}">{{ $address->full_address }} {{ $address->contact_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-remove').click(function () {
           ...
           swal({
              ...
              dangerMode: true,
               ...
               // 用户点击确定按钮，willDelete 的值会是 true,否则为 false
               if (!willDelete) {
                   return;
               }
        ...
        $('#select-all').change(function () {
           // 获取单选框的选中状态
           // prop() 方法可以知道标签中是否含某个属性，当单选框被勾选时，对应标签就会增加一个 checked 的属性
